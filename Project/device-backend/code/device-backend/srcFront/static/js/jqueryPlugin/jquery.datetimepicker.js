...
(function(factory){
  ...
  Datetimepicker.prototype = {
    ...
    place: function () {
      ...
      var offset, top, left, right = 'inherit', containerOffset;
      ...
      var pos = 'left';
      if ((bodyWidth - offset.left) < pickerWidth){
        pos = 'right';
        left = 'inherit';
        right = bodyWidth - (offset.left + eleWidth);
      }
      ...
      left = pos == 'left' ? left - containerOffset.left : left;
      ...
      if (pos == 'right'){
        this.picker.addClass('datetimepicker-pos-right');
      }
    },
    ...
    fill: function () {
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        html.push('<td class="' + classes.join(' ') + '"><div>' + prevMonth.getUTCDate() + '</div></td>');
